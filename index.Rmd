...
install.packages(c("shiny", "tidyverse", "palmerpenguins", "DT", "bslib", "thematic"))
```
...
---
### **Example 2:** a navigation bar with `tabPanel()`s and nested `tabsetPanel()`s
...
<span style = 'font-size:80%;'>If you want to reproduce the app I'm building, start with the layout structure detailed on [slide #54](https://ucsb-meds.github.io/shiny-workshop/#72) (*Example 2: a navigation bar with `tabPanel()`s and nested `tabsetPanel()`s*) </span>
