...
* <span style = 'font-size:80%;'>[Shiny server](https://www.rstudio.com/products/shiny/shiny-server/) is an open source server which you can deploy for free on your own hardware. It requires more setup and configureation, but can be used without a fee.</span>
...
There are [other ways]() to host shiny applications that we won't get into here but may be worthwhile to explore. It's important to consider security measures and ___ before deploying your application...?
