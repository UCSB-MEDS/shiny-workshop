...
install.packages(c("shiny", "tidyverse", "palmerpenguins", "shinythemes", "htmltools"))
```
...
<span style = 'font-size:80%;'>**Inputs** are the things that users can interact with (e.g. toggle, slide) and provide values to your app. **Outputs** are the R objects that your user sees (e.g. tables, plots) and are what respond when a user interacts with/changes an input value.</span>
