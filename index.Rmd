...
<span style = 'font-size:80%;'>**7.** briefly talk about other application frameworks and additional considerations</span> 
...
---
* reading in data & storing in 'raw'
* wrangling data in separate script + saving as .rds into app directory 
* import wrangled data into app.R
* add reactive DT table
* add reactive plot
---
class: inverse, center, middle
...
---
### **Exercise 8:** Add a theme to your app using `{bslib}`
...
---
### <span style = 'font-size:90%;'>**Exercise 9:** Add an image(s) to your app</span>
